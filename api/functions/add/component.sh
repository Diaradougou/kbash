...
# used in listing of information like the autogenerated help, when
# commands are listed one per line, this is the 'description'
function oneline_help_ENTRYPOINT_add_component() {
  echo "Add a new component (command scope and directory pair)"
}
export -f oneline_help_ENTRYPOINT_add_component


# This is the cmdline argument summary for autogenerated usage
#
function cmdline_help_ENTRYPOINT_add_component() {
  echo "[COMPONENT_ID] [VAR_PREFIX]"
}
export -f cmdline_help_ENTRYPOINT_add_component

# This is the full add_component help
#
function help_ENTRYPOINT_add_component() {
printf "`cat << EOF

usage: add-component [COMPONENT_ID] [VAR_PREFIX]
...
export -f help_ENTRYPOINT_add_component
